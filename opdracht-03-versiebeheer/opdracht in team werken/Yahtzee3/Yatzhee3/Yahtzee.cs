...
namespace Yatzhee3
{
  public partial class Yahtzee : Form
  {
    ...
    List<CheatsController> mCheatsControl = new List<CheatsController>();
    ...
    List<CheatsView> mCheatsViewList = new List<CheatsView>();
    CheatsView mCheatsview = new CheatsView();
    ...
    void changePlayer()
    {
      if (mPlayerControl[0].playerModel.PlayerOneActive)
      {
        ...
        mCheatsViewList[0].Enabled = false;
        mCheatsViewList[1].Enabled = true;
      ...
      else
      {
        ...
        mCheatsViewList[0].Enabled = true;
        mCheatsViewList[1].Enabled = false;
        mPlayerControl[0].SwitchPlayer();
